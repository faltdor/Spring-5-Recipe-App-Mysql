...
@Slf4j
@Profile({ "dev", "prod" })
public class DevBootstrapMySQL implements ApplicationListener<ContextRefreshedEvent> {
	...
	@Autowired
	public DevBootstrapMySQL(IRecipeRepository recipeRepository, ICategoryRepository categoryRepository,
	...
	public void onApplicationEvent(ContextRefreshedEvent arg0) {
		log.debug("Saving data to Dababase Mysql");
